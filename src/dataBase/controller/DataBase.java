...
public class DataBase {
     ...
     * mongoDB地址
     */
    private static final String MONGODB_SERVER_HOST = "mongodb://Andersen:213533@175.24.10.214:27017/admin";
    ...
    private final static MongoCollection<Document> userCollection = MongoDBAPI.getOrCreateCollection(lightChat, USER_COLLECTION_NAME);
    ...
    @SuppressWarnings("unused")
    private final static MongoCollection<Document> sessionCollection = MongoDBAPI.getOrCreateCollection(lightChat, SESSION_COLLECTION_NAME);
    ...
    synchronized public void checkRequest(final String requestorUsername, final String receiverUsername,
        ...
        Document requestorDocument = MongoDBAPI.findOneDocument(lightChat, USER_COLLECTION_NAME,
        ...
        requestorDocument = MongoDBAPI.findOneDocument(lightChat, USER_COLLECTION_NAME, searchRequestorDocument);
        ...
        MongoDBAPI.updateOneDocument(lightChat, USER_COLLECTION_NAME, requestorDocument, newRequestorDocument);
    }
